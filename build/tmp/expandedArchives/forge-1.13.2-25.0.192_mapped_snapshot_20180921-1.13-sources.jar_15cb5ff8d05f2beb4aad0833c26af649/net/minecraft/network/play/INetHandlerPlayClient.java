...
public interface INetHandlerPlayClient extends INetHandler {
   ...
   void handleTags(SPacketTagsList packetIn);
   ...
   void handleCommandList(SPacketCommandList packetIn);

   void handleStopSound(SPacketStopSound packetIn);
   ...
   void handleUpdateRecipes(SPacketUpdateRecipes packetIn);

   void handlePlayerLook(SPacketPlayerLook packetIn);

   void handleNBTQueryResponse(SPacketNBTQueryResponse packetIn);
}