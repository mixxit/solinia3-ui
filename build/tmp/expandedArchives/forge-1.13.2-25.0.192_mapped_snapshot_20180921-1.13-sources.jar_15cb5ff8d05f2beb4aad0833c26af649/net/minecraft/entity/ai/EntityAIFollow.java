...
public class EntityAIFollow extends EntityAIBase {
   ...
   public boolean shouldExecute() {
      List<EntityLiving> list = this.entity.world.getEntitiesWithinAABB(EntityLiving.class, this.entity.getBoundingBox().grow((double)this.areaSize), this.followPredicate);
      if (!list.isEmpty()) {
