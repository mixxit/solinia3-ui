...
public class EntityAIFollowOwnerFlying extends EntityAIFollowOwner {
   ...
   protected boolean isTeleportFriendlyBlock(int x, int z, int y, int xOffset, int zOffset) {
      ...
      return (iblockstate.isTopSolid() || iblockstate.isIn(BlockTags.LEAVES)) && this.world.isAirBlock(new BlockPos(x + xOffset, y, z + zOffset)) && this.world.isAirBlock(new BlockPos(x + xOffset, y + 1, z + zOffset));
   }
}