...
public class EntityDragon extends EntityLiving implements IEntityMultiPart, IMob {
      ...
      if (this.getHealth() <= 0.0F) {
         ...
         if (this.isAIDisabled()) {
            ...
            if (!this.world.isRemote && this.hurtTime == 0) {
               ...
               this.collideWithEntities(this.world.getEntitiesWithinAABBExcludingEntity(this, this.dragonPartWing2.getBoundingBox().grow(4.0D, 2.0D, 4.0D).offset(0.0D, -2.0D, 0.0D)));
   ...
   private void updateDragonEnderCrystal() {
      if (this.healingEnderCrystal != null) {
         if (this.healingEnderCrystal.removed) {
      ...
      if (this.rand.nextInt(10) == 0) {
         List<EntityEnderCrystal> list = this.world.getEntitiesWithinAABB(EntityEnderCrystal.class, this.getBoundingBox().grow(32.0D));
      ...
      for(int k1 = i; k1 <= l; ++k1) {
         for(int l1 = j; l1 <= i1; ++l1) {
            for(int i2 = k; i2 <= j1; ++i2) {
               ...
               if (!iblockstate.isAir(world, blockpos) && iblockstate.getMaterial() != Material.FIRE) {
                  if (!net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.world, this)) {
                     flag = true;
                  } else if (iblockstate.canEntityDestroy(this.world, blockpos, this) && net.minecraftforge.event.ForgeEventFactory.onEntityDestroyBlock(this, blockpos, iblockstate)) {
   ...
   public void writeAdditional(NBTTagCompound compound) {
      ...
      compound.setInt("DragonPhase", this.phaseManager.getCurrentPhase().getType().getId());
   }
