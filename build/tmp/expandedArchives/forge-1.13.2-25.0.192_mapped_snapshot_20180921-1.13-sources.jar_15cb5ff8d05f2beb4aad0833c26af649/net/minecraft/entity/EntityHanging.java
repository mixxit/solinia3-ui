...
public abstract class EntityHanging extends Entity {
      ...
      if (!this.world.isCollisionBoxesEmpty(this, this.getBoundingBox())) {
         ...
         for(int k = 0; k < i; ++k) {
            for(int l = 0; l < j; ++l) {
               ...
               if (iblockstate.getBlockFaceShape(this.world, blockpos$mutableblockpos, this.facingDirection) == net.minecraft.block.state.BlockFaceShape.SOLID)
                  continue;
   ...
   public void writeAdditional(NBTTagCompound compound) {
      ...
      compound.setInt("TileX", blockpos.getX());
      compound.setInt("TileY", blockpos.getY());
      compound.setInt("TileZ", blockpos.getZ());
   }
