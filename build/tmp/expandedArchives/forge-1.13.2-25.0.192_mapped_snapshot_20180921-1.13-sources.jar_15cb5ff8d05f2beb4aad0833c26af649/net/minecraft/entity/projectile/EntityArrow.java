...
public abstract class EntityArrow extends Entity implements IProjectile {
   ...
   public void onCollideWithPlayer(EntityPlayer entityIn) {
      if (!this.world.isRemote && (this.inGround || this.func_203047_q()) && this.arrowShake <= 0) {
         boolean flag = this.pickupStatus == EntityArrow.PickupStatus.ALLOWED || this.pickupStatus == EntityArrow.PickupStatus.CREATIVE_ONLY && entityIn.abilities.isCreativeMode || this.func_203047_q() && this.func_212360_k().getUniqueID() == entityIn.getUniqueID();
