...
public class EntityArgument implements ArgumentType<EntitySelector> {
   ...
   public static Entity getSingleEntity(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
   ...
   public static Collection<EntityPlayerMP> getPlayersAllowingNone(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
   ...
   public static EntityPlayerMP getOnePlayer(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
   ...
   public static Collection<EntityPlayerMP> getPlayers(CommandContext<CommandSource> context, String name) throws CommandSyntaxException {
      List<EntityPlayerMP> list = context.getArgument(name, EntitySelector.class).selectPlayers(context.getSource());
      if (list.isEmpty()) {
