...
public final class Material {
   ...
   public static final Material VINE = (new Material.Builder(MaterialColor.FOLIAGE)).doesNotBlockMovement().notOpaque().notSolid().pushDestroys().replaceable().flammable().build();
   ...
   public static final Material CIRCUITS = (new Material.Builder(MaterialColor.AIR)).doesNotBlockMovement().notOpaque().notSolid().pushDestroys().build();
   ...
   public static final Material CLOTH = (new Material.Builder(MaterialColor.WOOL)).flammable().build();
   ...
   public Material(MaterialColor materialMapColorIn, boolean liquid, boolean solid, boolean doesBlockMovement, boolean opaque, boolean requiresNoToolIn, boolean canBurnIn, boolean replaceableIn, EnumPushReaction mobilityFlag) {
