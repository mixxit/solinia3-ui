...
public class BlockPattern {
    ...
    */
   @Nullable
   public BlockPattern.PatternHelper match(IWorldReaderBase worldIn, BlockPos pos) {
   ...
   public static LoadingCache<BlockPos, BlockWorldState> createLoadingCache(IWorldReaderBase worldIn, boolean forceLoadIn) {
   ...
   static class CacheLoader extends com.google.common.cache.CacheLoader<BlockPos, BlockWorldState> {
      ...
      public CacheLoader(IWorldReaderBase worldIn, boolean forceLoadIn) {
         this.world = worldIn;
