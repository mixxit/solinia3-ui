...
public class BlockPistonStructureHelper {
   ...
   private boolean addBlockLine(BlockPos origin, EnumFacing facingIn) {
      ...
      if (iblockstate.isAir(world, origin)) {
         return true;
         ...
         if (i + this.toMove.size() > 12) {
            ...
            while(iblockstate.isStickyBlock()) {
               ...
               if (iblockstate.isAir(world, blockpos) || !BlockPistonBase.canPush(iblockstate, this.world, blockpos, this.moveDirection, false, this.moveDirection.getOpposite()) || blockpos.equals(this.pistonPos)) {
                  break;
               }
            ...
            while(true) {
               ...
               if (iblockstate.isAir(world, blockpos1)) {
                  return true;
               }
