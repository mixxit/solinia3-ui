...
public class ItemBoat extends Item {
   ...
   public ItemBoat(EntityBoat.Type typeIn, Item.Properties builder) {
      super(builder);
      this.type = typeIn;
   }
   ...
   public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
      ...
      if (raytraceresult == null) {
         ...
         if (flag) {
            ...
            EntityBoat entityboat = new EntityBoat(worldIn, raytraceresult.hitVec.x, raytraceresult.hitVec.y, raytraceresult.hitVec.z);
