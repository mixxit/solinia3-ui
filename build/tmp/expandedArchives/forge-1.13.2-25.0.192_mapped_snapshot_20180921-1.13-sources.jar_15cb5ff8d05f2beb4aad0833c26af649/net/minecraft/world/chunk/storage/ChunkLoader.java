...
public class ChunkLoader {
   ...
   public static void convertToAnvilFormat(ChunkLoader.AnvilConverterData converterData, NBTTagCompound compound, BiomeProvider provider) {
      compound.setInt("xPos", converterData.x);
      compound.setInt("zPos", converterData.z);
      ...
      for(int l2 = 0; l2 < 16; ++l2) {
         for(int i3 = 0; i3 < 16; ++i3) {
            ...
            abyte[i3 << 4 | l2] = (byte)(IRegistry.field_212624_m.getId(provider.getBiome(blockpos$mutableblockpos, Biomes.DEFAULT)) & 255);
         }
      }
      ...
      compound.setBoolean("convertedFromAlphaFormat", true);
   }
