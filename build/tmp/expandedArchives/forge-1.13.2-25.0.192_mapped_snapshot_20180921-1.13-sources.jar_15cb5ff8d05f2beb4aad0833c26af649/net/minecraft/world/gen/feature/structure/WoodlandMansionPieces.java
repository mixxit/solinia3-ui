   ...
   public static class MansionTemplate extends TemplateStructurePiece {
      ...
      protected void handleDataMarker(String function, BlockPos pos, IWorld worldIn, Random rand, MutableBoundingBox sbb) {
         if (function.startsWith("Chest")) {
            ...
            EntityEvoker entityevoker = new EntityEvoker(worldIn.getWorld());
            ...
            EntityVindicator entityvindicator = new EntityVindicator(worldIn.getWorld());
            entityvindicator.enablePersistence();
            entityvindicator.moveToBlockPosAndAngles(pos, 0.0F, 0.0F);
            entityvindicator.onInitialSpawn(worldIn.getDifficultyForLocation(new BlockPos(entityvindicator)), (IEntityLivingData)null, (NBTTagCompound)null);
