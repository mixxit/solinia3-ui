...
public class ChunkPaletteFormat extends DataFix {
   ...
   private Dynamic<?> fix(Dynamic<?> p_209712_1_) {
      ...
      return optional.isPresent() && optional.get().get("Sections").flatMap(Dynamic::getStream).isPresent() ? p_209712_1_.set("Level", (new ChunkPaletteFormat.UpgradeChunk(optional.get())).write()) : p_209712_1_;
   }
   ...
   static class Section {
      ...
      public Section(Dynamic<?> p_i49575_1_) {
         ...
         this.y = p_i49575_1_.getInt("Y");
         this.hasData = p_i49575_1_.get("Blocks").isPresent();
      }

      public Dynamic<?> getBlock(int p_210056_1_) {
         if (p_210056_1_ >= 0 && p_210056_1_ <= 4095) {
            Dynamic<?> dynamic = this.palette.get(this.buffer[p_210056_1_]);
      ...
      public int upgrade(int p_199207_1_) {
         if (!this.hasData) {
            ...
            ByteBuffer bytebuffer = this.section.get("Blocks").flatMap(Dynamic::getByteBuffer).get();
            ChunkPaletteFormat.NibbleArray chunkpaletteformat$nibblearray = this.section.get("Data").flatMap(Dynamic::getByteBuffer).map((p_210055_0_) -> {
               return new ChunkPaletteFormat.NibbleArray(DataFixUtils.toArray(p_210055_0_));
            }).orElseGet(ChunkPaletteFormat.NibbleArray::new);
            ChunkPaletteFormat.NibbleArray chunkpaletteformat$nibblearray1 = this.section.get("Add").flatMap(Dynamic::getByteBuffer).map((p_210052_0_) -> {
   ...
   static final class UpgradeChunk {
      ...
      public UpgradeChunk(Dynamic<?> p_i49574_1_) {
         ...
         this.x = p_i49574_1_.getInt("xPos") << 4;
         this.z = p_i49574_1_.getInt("zPos") << 4;
         p_i49574_1_.get("TileEntities").flatMap(Dynamic::getStream).ifPresent((p_210061_1_) -> {
            p_210061_1_.forEach((p_210063_1_) -> {
               int l3 = p_210063_1_.getInt("x") - this.x & 15;
               int i4 = p_210063_1_.getInt("y");
               int j4 = p_210063_1_.getInt("z") - this.z & 15;
               int k4 = i4 << 8 | j4 << 4 | l3;
