...
public class LeavesFix extends DataFix {
               ...
               Typed<?> typed = p_208420_3_.updateTyped(opticfinder1, (p_208415_3_) -> {
                  ...
                  if (int2objectmap.values().stream().allMatch(LeavesFix.Section::isSkippable)) {
                     ...
                     return p_208415_3_.updateTyped(opticfinder2, (p_208413_1_) -> {
                        return int2objectmap.get(p_208413_1_.get(DSL.remainderFinder()).getInt("Y")).write(p_208413_1_);
                     });
                  }
               });
               if (aint[0] != 0) {
   ...
   public static final class LeavesSection extends LeavesFix.Section {
      ...
      private int getDistance(int p_208459_1_) {
         return this.isLog(p_208459_1_) ? 0 : Integer.parseInt(this.palette.get(p_208459_1_).get("Properties").flatMap((p_209768_0_) -> {
   ...
   public abstract static class Section {
      final Type<Pair<String, Dynamic<?>>> blockStateType = DSL.named(TypeReferences.BLOCK_STATE.typeName(), DSL.remainderType());
      ...
      public Typed<?> write(Typed<?> p_208465_1_) {
         ...
         }).set(this.paletteFinder, (Typed)((List)this.palette).stream().map((p_212509_0_) -> {
