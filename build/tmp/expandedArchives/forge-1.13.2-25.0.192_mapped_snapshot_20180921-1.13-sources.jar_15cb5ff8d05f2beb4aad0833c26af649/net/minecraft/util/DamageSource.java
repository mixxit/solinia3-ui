...
public class DamageSource {
   ...
   public ITextComponent getDeathMessage(EntityLivingBase entityLivingBaseIn) {
      ...
      String s1 = s + ".player";
      return entitylivingbase != null ? new TextComponentTranslation(s1, entityLivingBaseIn.getDisplayName(), entitylivingbase.getDisplayName()) : new TextComponentTranslation(s, entityLivingBaseIn.getDisplayName());
   }
