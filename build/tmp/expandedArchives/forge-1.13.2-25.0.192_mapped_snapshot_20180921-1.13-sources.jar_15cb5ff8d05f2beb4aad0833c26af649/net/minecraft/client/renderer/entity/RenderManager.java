...
public class RenderManager {
   ...
   public RenderManager(TextureManager renderEngineIn, ItemRenderer itemRendererIn) {
      ...
      this.entityRenderMap.put(EntitySnowball.class, new RenderSprite<>(this, Items.SNOWBALL, itemRendererIn));
      this.entityRenderMap.put(EntityEnderPearl.class, new RenderSprite<>(this, Items.ENDER_PEARL, itemRendererIn));
      this.entityRenderMap.put(EntityEnderEye.class, new RenderSprite<>(this, Items.ENDER_EYE, itemRendererIn));
      this.entityRenderMap.put(EntityEgg.class, new RenderSprite<>(this, Items.EGG, itemRendererIn));
      this.entityRenderMap.put(EntityPotion.class, new RenderPotion(this, itemRendererIn));
      this.entityRenderMap.put(EntityExpBottle.class, new RenderSprite<>(this, Items.EXPERIENCE_BOTTLE, itemRendererIn));
      this.entityRenderMap.put(EntityFireworkRocket.class, new RenderSprite<>(this, Items.FIREWORK_ROCKET, itemRendererIn));
   ...
   public void cacheActiveRenderInfo(World worldIn, FontRenderer textRendererIn, Entity livingPlayerIn, Entity pointedEntityIn, GameSettings optionsIn, float partialTicks) {
      ...
      if (livingPlayerIn instanceof EntityLivingBase && ((EntityLivingBase)livingPlayerIn).isPlayerSleeping()) {
         ...
         if (block.isBed(iblockstate, worldIn, pos, livingPlayerIn)) {
            int i = block.getBedDirection(iblockstate, worldIn, pos).getHorizontalIndex();
