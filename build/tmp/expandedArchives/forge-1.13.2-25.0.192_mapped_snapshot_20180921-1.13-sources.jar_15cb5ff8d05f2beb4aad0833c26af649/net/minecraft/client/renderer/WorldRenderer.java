...
public class WorldRenderer implements IWorldEventListener, AutoCloseable, IResourceManagerReloadListener {
   ...
   public void playRecord(@Nullable SoundEvent soundIn, BlockPos pos) {
      ...
      if (soundIn != null) {
         ...
         ISound simplesound = SimpleSound.getRecordSoundRecord(soundIn, (float)pos.getX(), (float)pos.getY(), (float)pos.getZ());
   ...
   public void playEvent(EntityPlayer player, int type, BlockPos blockPosIn, int data) {
      ...
      case 1031:
         ...
         break;
      case 1032:
         this.mc.getSoundHandler().play(SimpleSound.getMasterRecord(SoundEvents.BLOCK_PORTAL_TRAVEL, random.nextFloat() * 0.4F + 0.8F));
         break;
      case 1033:
      ...
      case 2004:
         for(int i2 = 0; i2 < 20; ++i2) {
            ...
            this.world.spawnParticle(Particles.SMOKE, d19, d22, d24, 0.0D, 0.0D, 0.0D);
            this.world.spawnParticle(Particles.FLAME, d19, d22, d24, 0.0D, 0.0D, 0.0D);
         }
         break;
      case 2005:
