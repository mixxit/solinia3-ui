...
public abstract class Render<T extends Entity> {
   ...
   private void renderEntityOnFire(Entity entity, double x, double y, double z, float partialTicks) {
      ...
      TextureAtlasSprite textureatlassprite = texturemap.getSprite(ModelBakery.LOCATION_FIRE_0);
      TextureAtlasSprite textureatlassprite1 = texturemap.getSprite(ModelBakery.LOCATION_FIRE_1);
   ...
   private void renderShadowSingle(IBlockState state, double p_188299_2_, double p_188299_4_, double p_188299_6_, BlockPos p_188299_8_, float p_188299_9_, float p_188299_10_, double p_188299_11_, double p_188299_13_, double p_188299_15_) {
      if (state.isFullCube()) {
         VoxelShape voxelshape = state.getShape(this.getWorldFromRenderManager(), p_188299_8_.down());
   ...
   protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
      ...
      if (!(d0 > (double)(maxDistance * maxDistance))) {
         ...
         GameRenderer.drawNameplate(this.getFontRendererFromRenderManager(), str, (float)x, (float)y + f2, (float)z, i, f, f1, flag1, flag);
      }
   }
