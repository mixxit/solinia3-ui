...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
   ...
   public void handleJoinGame(SPacketJoinGame packetIn) {
      ...
      this.world = new WorldClient(this, new WorldSettings(0L, packetIn.getGameType(), false, packetIn.isHardcoreMode(), packetIn.getWorldType()), packetIn.func_212642_e(), packetIn.getDifficulty(), this.client.profiler);
      this.client.gameSettings.difficulty = packetIn.getDifficulty();
      this.client.loadWorld(this.world);
      this.client.player.dimension = packetIn.func_212642_e();
   ...
   public void handleSpawnObject(SPacketSpawnObject packetIn) {
      ...
      if (packetIn.getType() == 10) {
         ...
         entity = new EntityItemFrame(this.world, new BlockPos(d0, d1, d2), EnumFacing.byIndex(packetIn.getData()));
         packetIn.setData(0);
         ...
         entity = new EntityFallingBlock(this.world, d0, d1, d2, Block.getStateById(packetIn.getData()));
         packetIn.setData(0);
      ...
      if (entity != null) {
         ...
         if (packetIn.getData() > 0) {
            if (packetIn.getType() == 60 || packetIn.getType() == 91 || packetIn.getType() == 94) {
               ...
               if (entity3 instanceof EntityLivingBase && entity instanceof EntityArrow) {
                  ...
                  if (entity3 instanceof EntityPlayer) {
                     ...
                     if (((EntityPlayer)entity3).abilities.isCreativeMode) {
   ...
   public void handleSpawnPainting(SPacketSpawnPainting packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
      EntityPainting entitypainting = new EntityPainting(this.world, packetIn.getPosition(), packetIn.getFacing(), packetIn.func_201063_e());
   ...
   public void handleChunkData(SPacketChunkData packetIn) {
      ...
      Chunk chunk = this.world.getChunkProvider().func_212474_a(i, j, packetIn.getReadBuffer(), packetIn.getExtractedSize(), packetIn.isFullChunk());
      this.world.markBlockRangeForRenderUpdate(i << 4, 0, j << 4, (i << 4) + 15, 256, (j << 4) + 15);
      if (!packetIn.isFullChunk() || this.world.dimension.shouldClientCheckLighting()) {
   ...
   public void handleAnimation(SPacketAnimation packetIn) {
      ...
      if (entity != null) {
         if (packetIn.getAnimationType() == 0) {
            ...
            this.client.particles.addParticleEmitter(entity, Particles.CRIT);
         } else if (packetIn.getAnimationType() == 5) {
            this.client.particles.addParticleEmitter(entity, Particles.ENCHANTED_HIT);
         }
   ...
   public void handleSpawnMob(SPacketSpawnMob packetIn) {
      ...
      float f = (float)(packetIn.getYaw() * 360) / 256.0F;
      float f1 = (float)(packetIn.getPitch() * 360) / 256.0F;
      EntityLivingBase entitylivingbase = (EntityLivingBase)EntityType.create(packetIn.getEntityType(), this.client.world);
      if (entitylivingbase != null) {
   ...
   public void handleRespawn(SPacketRespawn packetIn) {
      ...
      if (dimensiontype != this.client.player.dimension) {
         ...
         this.world = new WorldClient(this, new WorldSettings(0L, packetIn.getGameType(), false, this.client.world.getWorldInfo().isHardcore(), packetIn.getWorldType()), packetIn.func_212643_b(), packetIn.getDifficulty(), this.client.profiler);
      ...
      this.client.func_212315_a(packetIn.func_212643_b());
      this.client.playerController.setGameType(packetIn.getGameType());
   }
   ...
   public void handleCommandList(SPacketCommandList packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
      this.commandDispatcher = new CommandDispatcher<>(packetIn.getRoot());
   }

   public void handleStopSound(SPacketStopSound packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
   ...
   public void handleTabComplete(SPacketTabComplete packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
      this.clientSuggestionProvider.func_197015_a(packetIn.getTransactionId(), packetIn.getSuggestions());
   }

   public void handleUpdateRecipes(SPacketUpdateRecipes packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
   ...
   public void handlePlayerLook(SPacketPlayerLook packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
      Vec3d vec3d = packetIn.func_200531_a(this.world);
      if (vec3d != null) {
         this.client.player.lookAt(packetIn.func_201064_a(), vec3d);
      }

   }

   public void handleNBTQueryResponse(SPacketNBTQueryResponse packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
      if (!this.nbtQueryManager.handleResponse(packetIn.func_211713_b(), packetIn.getTag())) {
         LOGGER.debug("Got unhandled response to tag query {}", (int)packetIn.func_211713_b());
      }
   ...
   public void handleRecipeBook(SPacketRecipeBook packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
      RecipeBookClient recipebookclient = this.client.player.getRecipeBook();
      recipebookclient.setGuiOpen(packetIn.isGuiOpen());
      recipebookclient.setFilteringCraftable(packetIn.isFilteringCraftable());
      recipebookclient.setFurnaceGuiOpen(packetIn.isFurnaceGuiOpen());
      recipebookclient.setFurnaceFilteringCraftable(packetIn.isFurnaceFilteringCraftable());
   ...
   public void handleEntityEffect(SPacketEntityEffect packetIn) {
      ...
      if (entity instanceof EntityLivingBase) {
         ...
         if (potion != null) {
            PotionEffect potioneffect = new PotionEffect(potion, packetIn.getDuration(), packetIn.getAmplifier(), packetIn.getIsAmbient(), packetIn.doesShowParticles(), packetIn.func_205527_h());
   ...
   public void handleTags(SPacketTagsList packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
   ...
   public void handlePlayerAbilities(SPacketPlayerAbilities packetIn) {
      ...
      entityplayer.abilities.setFlySpeed((double)packetIn.getFlySpeed());
   ...
   public void handleCustomSound(SPacketCustomSound packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
      this.client.getSoundHandler().play(new SimpleSound(packetIn.func_197698_a(), packetIn.getCategory(), packetIn.getVolume(), packetIn.getPitch(), false, 0, ISound.AttenuationType.LINEAR, (float)packetIn.getX(), (float)packetIn.getY(), (float)packetIn.getZ()));
   }
   ...
   public void handlePlaceGhostRecipe(SPacketPlaceGhostRecipe packetIn) {
      ...
      if (container.windowId == packetIn.func_194313_b() && container.getCanCraft(this.client.player)) {
         IRecipe irecipe = this.recipeManager.getRecipe(packetIn.func_199615_a());
         if (irecipe != null) {
            if (this.client.currentScreen instanceof IRecipeShownListener) {
